...
try {
  ...
  if (isset($_GET['deleteid'])) {
    ...
    $sql1 = "DELETE FROM contactus where id=$del";
    if ($conn->query($sql1)) {
...
<body>
  ...
  <main>
    ...
    <section id="contact">
      ...
      ?>
        <h2 class="heading">Help/Support List</h2>
        <table border="1" cellspacing="5" cellpadding="5px">
          ...
          ?>
            <tr class="table-data">
              ...
              <td class="help-support"><a href="contactList.php?deleteid=<?php echo $row['id'] ?>">Delete</a></td>
            </tr>
          <?php
          }
          ?>
  ...
  <footer>
    <h4>You are here: Help and Support</h4>
    <div class="footer">
